//! The axis-colored Cartesian cube with an orbit camera.
//!
//! Hold the **left mouse button** and drag to rotate the view: horizontal
//! drag orbits around the world Z axis, vertical drag tilts the camera
//! elevation (clamped so the view can not flip over the poles).
...
/// Elevation clamp: past ±80° the Z-up view matrix degenerates.
...
impl Stage {
    ...
    fn view_projection(&self, width: f32, height: f32) -> Mat4 {
        // Orbit camera: yaw circles around the world Z axis, pitch is the
